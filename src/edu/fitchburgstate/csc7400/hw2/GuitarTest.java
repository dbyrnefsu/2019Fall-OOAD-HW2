...
class GuitarTest {
	...
	void test_getManufacturer() {
		...
		String returned = this.testGuitar.getManufacturer().name();
	...
	void test_getType() {
		...
		String returned = this.testGuitar.getType().name();
	...
	void test_getBackWood() {
		...
		String returned = this.testGuitar.getBackWood().name();
	...
	void test_getTopWood() {
		...
		String returned = this.testGuitar.getTopWood().name();
